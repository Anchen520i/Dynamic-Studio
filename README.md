...
[Proxy Group]
𝐎𝐜𝐭𝐨𝐩𝐮𝐬 = smart, policy-path=订阅链接, policy-priority=香:0.5;台:0.6;新:0.7;日:0.8;美:0.9
...
𝐉𝐚𝐩𝐚𝐧 = smart, include-other-group=𝐎𝐜𝐭𝐨𝐩𝐮𝐬, policy-regex-filter=🇯🇵|日|JP
𝐓𝐚𝐢𝐖𝐚𝐧 = smart, include-other-group=𝐎𝐜𝐭𝐨𝐩𝐮𝐬, policy-regex-filter=🇨🇳|台|TW
𝐀𝐦𝐞𝐫𝐢𝐜𝐚 = smart, include-other-group=𝐎𝐜𝐭𝐨𝐩𝐮𝐬, policy-regex-filter=🇺🇸|美|US
𝐇𝐨𝐧𝐠𝐊𝐨𝐧𝐠 = smart, include-other-group=𝐎𝐜𝐭𝐨𝐩𝐮𝐬, policy-regex-filter=🇭🇰|港|HK
𝐒𝐢𝐧𝐠𝐚𝐩𝐨𝐫𝐞 = smart, include-other-group=𝐎𝐜𝐭𝐨𝐩𝐮𝐬, policy-regex-filter=🇸🇬|新|SG
