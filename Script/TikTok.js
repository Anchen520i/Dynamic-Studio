...
if (typeof $argument !== 'undefined' && $argument !== "") {loc = this.$argument ?? "JP";} else {lk = $persistentStore.read("TikTok解锁地区");loc = keyus[lk] || "JP";if(loc == "inkey"){inkeys = $persistentStore.read("手动输入地区代码[可选]");loc = inkeys;}};
